 ...
 * @author fabia
 */
public class ReplaceDlg extends javax.swing.JDialog
{
  ...
  public ReplaceDlg(java.awt.Frame parent, boolean modal)
  {
    super(parent, modal);
    initComponents();
  }
  ...
  public void get(Location loc)
  {
    ...
    tfCountry.setText(loc.getCountry());
  }
  ...
  public static void main(String args[])
  {
    ...
    {
      java.util.logging.Logger.getLogger(ReplaceDlg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable()
    {
      public void run()
      {
        ReplaceDlg dialog = new ReplaceDlg(new javax.swing.JFrame(), true);
